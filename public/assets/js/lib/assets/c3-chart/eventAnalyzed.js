$(function() {
  ...
  var years = ['year'
            ...
            ,'2014-10-21'	,'2014-10-22'	,'2014-10-23'	,'2014-10-24'	,'2014-10-25'	,'2014-10-26'	,'2014-10-27'	,'2014-10-28'	,'2014-10-29'	,'2014-10-30'
            ,'2014-10-31'
  ...
  $.each(json0, function(key, value) {
    ...
    for(var i = strt; i < years.length; ++i){
      if(years[i] == this.event_day.toString()){
  ...
  $.each(json1, function(key, value) {
    ...
    for(var i = strt; i < years.length; ++i){
      if(years[i] == this.dating.toString()){
        visitors_nums.push(this.visitors_num);
        strt = i;
        break;
      }
      else{
        visitors_nums.push(0);
      }
    }
  });
